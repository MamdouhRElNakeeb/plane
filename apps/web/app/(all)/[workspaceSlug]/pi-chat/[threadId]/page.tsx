...
export default function CreteAIThreadPage({ params }: Route.ComponentProps) {
  return (
    <>
      <PageHead title="Crete AI" />
      <main className="size-full overflow-hidden rounded-md border border-subtle-1 bg-surface-1">
        <CreteAIChatRoot workspaceSlug={params.workspaceSlug} threadId={params.threadId} variant="page" />
      </main>
    </>
  );
}
