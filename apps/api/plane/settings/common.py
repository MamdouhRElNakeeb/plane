...
CRETE_AI_REPORT_CATALOG_KIND_LIMIT = int(os.environ.get("CRETE_AI_REPORT_CATALOG_KIND_LIMIT", "100"))
CRETE_AI_REPORT_CATALOG_LIMIT = int(os.environ.get("CRETE_AI_REPORT_CATALOG_LIMIT", "500"))
CRETE_AI_REPORTING_ENABLED = os.environ.get("CRETE_AI_REPORTING_ENABLED", "0") == "1"
